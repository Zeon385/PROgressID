...
const string strMessageMagic = "progressid Signed Message:\n";
...
{
    int64 nSubsidy = 385 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // progressid: 1 days
static const int64 nTargetSpacing = 2400; // progressid: 40 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal progressid miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "progressid", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x39bb93203bc0ad20cddd6118101b1585ba52611b80d24c6f6c319e1d7043949a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1519665388; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 482624;

        if (fTestNet)
        {
            block.nTime    = 1519665388;
            block.nNonce   = 482624;
        }
        ...
        assert(block.hashMerkleRoot == uint256("8cdc78f4b73f371b52ffd84b83c176eee5556ba8e22efbcafe74edcf2b7b7120"));
